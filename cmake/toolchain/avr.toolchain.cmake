...
set(ARDUINO_CORE_PATH ${ARDUINO_PATH}/hardware/arduino/avr/cores/arduino)
set(ARDUINO_TOOLS_PATH ${ARDUINO_PATH}/hardware/tools/avr/bin)
set(ARDUINO_AVRDUDE_CONF ${ARDUINO_PATH}/hardware/tools/avr/etc/avrdude.conf)
...
find_program(ARDUINO_AVRDUDE avrdude PATHS "${ARDUINO_TOOLS_PATH}" NO_DEFAULT_PATH
    DOC "Path to avrdude")
